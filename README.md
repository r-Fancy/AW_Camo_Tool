...
It copies one image multiple times, using the number of weapon names for the camo type you choose. It then renames the images to match that specific camo type.
